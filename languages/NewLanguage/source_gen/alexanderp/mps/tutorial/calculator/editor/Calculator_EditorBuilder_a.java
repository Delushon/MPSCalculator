...
/*package*/ class Calculator_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private static class inputFieldListHandler_uh00px_c0 extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.inputField$f2vS;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.InputField$ik;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(inputFieldListHandler_uh00px_c0.this.getNode(), LINKS.inputField$f2vS));
      try {
  ...
  private static class outputFieldListHandler_uh00px_e0 extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.outputField$V_$S;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.OutputField$2N;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(outputFieldListHandler_uh00px_e0.this.getNode(), LINKS.outputField$V_$S));
      try {
        EditorCell emptyCell = null;
        emptyCell = super.createEmptyCell();
        installElementCellActions(null, emptyCell, true);
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept InputField$ik = MetaAdapterFactory.getConcept(0x5c6ee37bd0c245eeL, 0xadf793b96280be62L, 0xa5a8419bfb013ccL, "alexanderp.mps.tutorial.calculator.structure.InputField");
    /*package*/ static final SConcept OutputField$2N = MetaAdapterFactory.getConcept(0x5c6ee37bd0c245eeL, 0xadf793b96280be62L, 0xa5a8419bfb03378L, "alexanderp.mps.tutorial.calculator.structure.OutputField");
  }
